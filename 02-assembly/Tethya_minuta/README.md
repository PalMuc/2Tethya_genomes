...
![Alt-Text](GC_content_vs_ln_sequence_length.png)
...
```
![cumulative length plot](cumulative_length_plot.png)
![histogram of contig GC percent](GC_histogram.png)
## BUSCO
...
![plot of T minuta GC versus coverage](Tethya_minuta_all_scaffolded_LRS_P_RNAscaffolds.fasta.png)
